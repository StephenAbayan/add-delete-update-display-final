    ...
    while(choice=="yes"):
        ...
        for line in file:
            ...
            if idnum == nput:
                ...
                opt_del.close()
        choice = raw_input("Continue Deleting? [yes or no]: ")
...
def update():
    ...
    while(select == "yes"):
        ...
        select = raw_input("Want to update another Student? [yes or no]: ")
...
while True:
    try:
        ...
        if answer in range(1,5):
            ...
            print "Out of range! Make sure to type the correct key!"
            menu()
